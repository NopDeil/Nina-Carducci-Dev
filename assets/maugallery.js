  ...
  $.fn.mauGallery.methods = {
    ...
    filterByTag() {
      ...
      if (tag === "all") {
        ...
        $(".nav-link[data-images-toggle='Concert']").addClass("active");
      } else if (tag === "Entreprises") {
        $(".nav-link[data-images-toggle='Entreprises']").addClass("active");
      } else if (tag === "Mariages") {
        $(".nav-link[data-images-toggle='Mariages']").addClass("active");
      } else if (tag === "Portrait") {
        $(".nav-link[data-images-toggle='Portrait']").addClass("active");
      }
